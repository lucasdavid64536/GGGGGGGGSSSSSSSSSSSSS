...
if(!cmd||cmd==='1'){
  ...
  .addField('**THERE IS ALSO ANTI BAD WORDS BLOCKED**', "Don't Say Anything Bad Or Bot Will Spam Your Dms")
  .addField('**There Are A Report System With .report @user <reason> usage ! So You WAnt It Work You Should Make A Channel Wil reports name To make This Command work**', "**Don't Forget This Advice ! Make A Channel With** ``log`` **Name !**")
