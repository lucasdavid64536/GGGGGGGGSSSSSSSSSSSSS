...
if(!cmd||cmd==='1'){
  ...
  .addField("**Moderation**","Kick , Ban , Warn , clear , Send , Dm , addrole , removerole  Are A Seriously Commands ! **addrole/removerole usage: .addrole @user Rolename  Remember Don't Mention the role Just Put Hes Name**")
