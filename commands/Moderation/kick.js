...
module.exports.run = async (bot, message, args) => {
    ...
    if(bUser.hasPermission("MANAGE_MESSAGES")) return message.channel.send("**This User Cant Be Kicked Because He Had A Role Highler Than You** ``/OR/`` **He Is The Owner Of This Server** ``/OR/`` He Had Administrator Permission");
